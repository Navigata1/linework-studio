...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: "Sketch → CAD",
    blurb:
      "Photograph a napkin sketch or rough draft. Three AI loops — draft, judge, audit — extract the plan, repair its geometry, and solidify it into clean, layered linework you download as a native DXF for AutoCAD.",
    href: "/studio/sketch",
    accent: "blue",
    status: "live",
    public: false,
